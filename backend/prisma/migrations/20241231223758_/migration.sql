...
-- DropForeignKey
ALTER TABLE "categorys" DROP CONSTRAINT "categorys_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "categorys" ADD CONSTRAINT "categorys_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
